...
```
### Exercise 3 What message is more clear in your visualization than it was in the original visualization?

It is more clear in the new visualization that cases in the mask mandate county decreased over time, whereas the no mask mandate county cases stayed the same. 
...
Considering the mask mandate county started with many more cases than the no mask county, I would be interested in some background info on these counties including: type of county (aka urban or rural) and population size. 